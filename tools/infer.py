...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='Neural Visionaries model.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='images', help='the source path, e.g. image-file/dir.')
    parser.add_argument('--yaml', type=str, default='data.yaml', help='data yaml file.')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640], help='the image-size(h,w) in inference size.')
    parser.add_argument('--conf-thres', type=float, default=0.40, help='confidence threshold for inference.')
    parser.add_argument('--iou-thres', type=float, default=0.50, help='NMS IoU threshold for inference.')
    ...
    parser.add_argument('--project', default='', help='save inference results to project/name.')
    parser.add_argument('--name', default='outputs', help='save inference results to project/name.')
